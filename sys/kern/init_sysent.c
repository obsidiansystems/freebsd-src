...
struct sysent sysent[] = {
	...
	{ .sy_narg = AS(pdchroot_args), .sy_call = (sy_call_t *)sys_pdchroot, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 615 = pdchroot */
	{ .sy_narg = AS(pdcap_enter_args), .sy_call = (sy_call_t *)sys_pdcap_enter, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 616 = pdcap_enter */
};
