...
int pdexec(int procfd, int fd, char **argv, char **envv, int flags)
{ return syscall(SYS_pdexec, procfd, fd, argv, envv, flags); }
int pdsetfd(int procfd, int child_fd, int parent_fd)
{ return syscall(SYS_pdsetfd, procfd, child_fd, parent_fd); }
