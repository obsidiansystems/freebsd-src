...
let
  # src = null: the shell only needs the build *environment* (tools,
  # hooks, makeFlags); upstream-main sources are good enough for that,
  # and this avoids re-snapshotting the working tree on shell entry.
